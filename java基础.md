<!-- TOC -->autoauto- [java基本概念](#java基本概念)auto    - [1.什么是环境变量？path、classPath](#1什么是环境变量pathclasspath)auto    - [2.JDK（Java Development Kit)里面有什么？](#2jdkjava-development-kit里面有什么)auto    - [3.什么是JRE（Java Runtime Environment : java运行环境）?](#3什么是jrejava-runtime-environment--java运行环境)auto    - [4.什么是JVM（Java Virtual Machine:java虚拟机）？](#4什么是jvmjava-virtual-machinejava虚拟机)auto- [java变量](#java变量)auto    - [变量](#变量)auto    - [布尔类型](#布尔类型)auto    - [字符类型](#字符类型)auto    - [数值类型](#数值类型)auto- [类和对象](#类和对象)auto    - [构造函数（构建器）](#构造函数构建器)auto    - [this关键字](#this关键字)auto    - [super关键字](#super关键字)auto    - [static关键字](#static关键字)auto    - [访问权限（default、public、private、protected）](#访问权限defaultpublicprivateprotected)auto    - [面向对象基础](#面向对象基础)auto    - [main函数](#main函数)auto    - [包](#包)auto    - [单例设计模式](#单例设计模式)auto    - [继承](#继承)auto    - [final](#final)auto    - [强制类型转换](#强制类型转换)auto    - [抽象类](#抽象类)auto    - [模板方法设计模式](#模板方法设计模式)auto    - [对象包装器和自动装箱](#对象包装器和自动装箱)auto    - [接口](#接口)auto    - [多态](#多态)auto    - [内部类](#内部类)auto        - [匿名内部类](#匿名内部类)auto    - [异常](#异常)auto    - [多进程](#多进程)auto    - [String](#string)auto    - [集合](#集合)autoauto<!-- /TOC -->
